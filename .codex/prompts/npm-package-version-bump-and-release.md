...
You are executing the Codex-native prompt mirror for Claude Code command `/npm-package-version-bump-and-release`.
...
Source: `.claude/commands/npm-package-version-bump-and-release.md`
