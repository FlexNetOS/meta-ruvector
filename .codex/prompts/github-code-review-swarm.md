...
You are executing the Codex-native prompt mirror for Claude Code command `/github:code-review-swarm`.
...
gh pr comment 123 --body "ð Multi-agent code review initiated"
```
...
ð **Security Issue: [Type]**

**Severity**: ð´ Critical / ð¡ High / ð¢ Low
