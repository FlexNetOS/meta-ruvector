...
You are executing the Codex-native prompt mirror for Claude Code command `/hive-mind/hive-mind-consensus`.
...
Source: `.claude/commands/hive-mind/hive-mind-consensus.md`
