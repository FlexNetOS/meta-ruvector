...
You are executing the Codex-native prompt mirror for Claude Code command `/github:release-manager`.
...
mcp__github__create_pull_request {
  ...
  base: "main",
  body: `## ð Release v1.0.72

### ð¯ Release Highlights
