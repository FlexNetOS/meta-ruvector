...
You are executing the Codex-native prompt mirror for Claude Code command `/claude-flow-swarm`.
...
# ð Claude-Flow Swarm Coordination
...
For detailed documentation, see: https://github.com/FlexNetOS/claude-code-flow/docs/swarm-system.md
