...
You are executing the Codex-native prompt mirror for Claude Code command `/training:neural-patterns`.
...
## Benefits
- ð§  Learns your coding style
- ð Improves with each use
- ð¯ Better task predictions
- â¡ Faster coordination
