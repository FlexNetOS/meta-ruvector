...
You are executing the Codex-native prompt mirror for Claude Code command `/analysis:token-efficiency`.
...
- ð 32.3% average token reduction
- ð¯ More focused operations
- ð Intelligent result reuse
- ð Cumulative improvements
