...
You are executing the Codex-native prompt mirror for Claude Code command `/github:sync-coordinator`.
...
Bash(`gh pr create \
  ...
  --base "main" \
  --body "## ð GitHub Workflow Integration

### Features Added
- â Comprehensive GitHub command modes
- â Swarm-coordinated PR management
- â Automated issue tracking
- â Cross-package synchronization
