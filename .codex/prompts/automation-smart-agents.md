...
You are executing the Codex-native prompt mirror for Claude Code command `/automation/smart-agents`.
...
## Benefits
- ð¤ Zero manual agent management
- ð¯ Perfect agent selection
- ð Dynamic scaling
- ð¾ Resource efficiency
