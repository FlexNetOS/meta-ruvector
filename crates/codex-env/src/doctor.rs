...
pub fn doctor_codex_surface(options: DoctorOptions) -> Result<DoctorReport> {
    ...
    let (config_model, config_reasoning_effort, config_approval_policy, config_approvals_reviewer) =
...
fn validate_config(codex_dir: &Path) -> Result<(String, String, String, String)> {
    ...
    Ok((model, effort, approval_policy, approvals_reviewer))
}
