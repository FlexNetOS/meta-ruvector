    ...
    fn eval(&self, a: &[f32], b: &[f32]) -> f32 {
        ...
        match self.metric {
            ...
            DistanceMetric::DotProduct => {
                // Negate for minimization. NOT clamped: dot_product_distance
                // returns -dot, genuinely negative for positively-correlated
                // pairs, and clamping would collapse them all to 0 and destroy
                // the ranking HNSW searches on. This fork keeps them signed.
                -simd_intrinsics::dot_product_simd(a, b)
            }
